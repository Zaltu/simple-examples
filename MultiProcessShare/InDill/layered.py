...
def __furigana_conv__():
    ...
    kakasi.setMode("s", True)
    return kakasi.getConverter().do
FURIGANA_CONV = __furigana_conv__()
...
def __hiragana_conv__():
    ...
    kakasi.setMode("s", True)
    return kakasi.getConverter().do
HIRAGANA_CONV = __hiragana_conv__()
...
class JPStr:
    ...
    def __init__(self, string, default="romaji"):
        ...
        self.hiragana = HIRAGANA_CONV(string)
        self.romaji = ROMAJI_CONV(string)
        self.furigana = FURIGANA_CONV(string)
